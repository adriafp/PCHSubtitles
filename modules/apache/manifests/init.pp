...
#      ,File["/etc/apache2/conf.d/phpmyadmin.conf"]
  ...
  file { "/etc/apache2/sites-available/cshopping":
  	ensure => present,
  	source => "/vagrant/manifests/cshopping",
  	require => Package['apache2'],
  }

  file { "/etc/apache2/sites-enabled/cshopping":
    ensure => link,
    target => "/etc/apache2/sites-available/cshopping",
    require => Package['apache2'],
  }
